...
class jumpList:
    ...
    def create_custom(self, filename, links):
        prefix = b'\x01\x14\x02\x00\x00\x00\x00\x00\xC0\x00\x00\x00\x00\x00\x00\x46'
        fileend = b'\xAB\xFB\xBF\xBA'
    ...
    def read_auto(self, filename):
        ...
        for i in range(total):
            ...
            # print(new_vol_id, new_obj_id, birth_vol_id, birth_obj_id, netbios, entry_id, last_access, pin_status, access_count,
            #       length, data)
    ...
    def edit_auto(self, old_filename, new_filename, link_filename):
